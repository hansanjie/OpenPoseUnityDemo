...
Imports 40+ 3D file formats.
Supports external and embedded materials.
Supports skinned meshes and animations.
Mesh post-processing features.
Multi-platform: Windows Store, Windows, macOS, Linux, Android, iOS.

TriLib website:
http://ricardoreis.net/?p=14

TriLib newsletter:
http://ricardoreis.net/?page_id=192

API reference:
http://ricardoreis.net/trilib/manual/html/
