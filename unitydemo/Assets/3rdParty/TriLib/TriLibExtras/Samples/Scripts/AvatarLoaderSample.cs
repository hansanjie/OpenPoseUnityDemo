...
//#if UNITY_2017_1_OR_NEWER
            //throw new Exception("Unity no longer supports runtime avatar creation.");
//#else
#if UNITY_EDITOR
...
#if UNITY_EDITOR
            var modelsPath = Path.Combine(Path.GetFullPath("./Assets/3rdParty/TriLib/TriLibExtras/Samples"), ModelsDirectory);
#else
